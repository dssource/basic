...
class BaseSection extends ActiveRecord
{
    ...
    public function init()
    {
        ...
        $this->scenario = self::SCENARIO_SECTION_FOR_PAGES;
    ...
    */
    ...
    public function uploadImage()
    {
        ...
        $newName = date(dmyhis).'-'.Yii::$app->getModule('site')->imagePath.'/'.$newName;
    ...
    public function rules()
    {
        return [
            ['class', 'required'],
            [['name', 'alias', 'isParent', 'id_parent', 'show_in_catalog'], 'required', 'on' => self::SCENARIO_SECTION_FOR_PAGES],
            ['description', 'safe'],
